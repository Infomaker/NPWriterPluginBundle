...
```json
{
    ...
    "name": "ximconcept",
    "url": "http://localhost:5001/im-ximconcept.js?concept=author",
    "style": "http://localhost:5001/im-ximconcept.css?concept=author",
    "enabled": true,
    "mandatory": false,
    "data": {
        "label": "Författare",
...
```json
{
    ...
    "name": "ximconcept",
    "url": "http://localhost:5001/im-ximconcept.js?concept=tags",
    "style": "http://localhost:5001/im-ximconcept.css?concept=tags",
    "enabled": true,
    "mandatory": false,
    "data": {
        "label": "Taggar",
...
- `"pubStatus": "imext:draft"` Used when a new concept is created from the writer, defauts to "imext:draft"
...
- `"contenttype": "Concept",` Concepts contetType in OC
- `"broaderLimit": 3,` "How hight" ConceptService should follow Broader links
...
Concepts with a `rel broad` will be decorated with data about the concepts hierarchical chain to the depth specified in COncepService Config:
